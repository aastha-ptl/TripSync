...
class FamilyLeaderDashboardScreen extends StatefulWidget {
  ...
  const FamilyLeaderDashboardScreen({
    super.key,
    this.tripData,
  ...
  @override
  State<FamilyLeaderDashboardScreen> createState() => _FamilyLeaderDashboardScreenState();
}

class _FamilyLeaderDashboardScreenState extends State<FamilyLeaderDashboardScreen> {
        ...
        for (var day in days) {
          ...
          for (var act in acts) {
            ...
            items.add({
              ...
              'time': 'Today',
              'timestamp': DateTime.now().subtract(Duration(hours: dayNum)),
  ...
  String _formatRelativeTime(DateTime dt) {
    ...
    if (diff.inHours < 1) {
      return '${max(1, diff.inMinutes)}m ago';
